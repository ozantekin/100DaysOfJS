    ...
    */
    ...
    return {
        ...
        addingState:function(item){ // uyguluma ilk çalıştığı zaman bunu devreye sokmamız gerekiyor. Bunu init içinde yapıyoruz
            ...
            if (item){
                item.classList.remove("bg-success"); // save changes dediğimix anda güncelleme yapılır ve bg class silinir
            }
        ...
        editState:function(tr){ // bunu da app içinde yapıyoruz
            ...
            const parent = tr.parentNode; // bunun sayesinde tbody ulaşıyoruz
            for(let i=0; i<parent.children.length; i++){ // bunu yapma amacımız tbody altında birden fazla tr elemanı olursa diğer elamanın edit btn basınca bg değişmesini sağlamak istiyoruz
...
const App= (function(ProductCtrl,UICtrl){ 
    ...
    const editProductSubmit = function (e){
        ...
        if(productName !== '' && productPrice !== ''){
            ...
            UICtrl.addingState(item); // ui içindeki adding state gitememiz gerek. bg-success kaldırıyoruz
